  ...
  methods: {
    ...
    submit() {
      ...
      this.$refs.form.submit().then((res) => {
        common_vendor.index.__f__("log", "at pages/validate-demo/add.vue:127", res, "000");
        this.submitForm(res);
      }).catch((errors) => {
    ...
    submitForm(value) {
      db.collection(dbCollectionName).add(value).then((res) => {
        common_vendor.index.__f__("log", "at pages/validate-demo/add.vue:137", "res:---- ", res);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    J: common_vendor.sr("form", "57fa48dd-0"),
    K: common_vendor.p({
      value: $data.formData,
...
//# sourceMappingURL=../.sourcemap/mp-weixin/add.js.map
