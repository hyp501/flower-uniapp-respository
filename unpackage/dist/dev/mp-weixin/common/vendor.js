...
function initRuntimeSocketService() {
  const hosts = "192.168.32.91,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_ni4h43";
...
const pages = [
  ...
  {
    path: "pages/profile/timeline",
    style: {
      navigationBarTitleText: "成长日志",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/profile/rules",
    style: {
  ...
  list: [
    {
      ...
      selectedIconPath: "static/tabbar/flower1.png",
      text: "花园"
    },
    {
...
const globalStyle = {
  ...
  navigationBarTitleText: "plantFlower",
