...
const _sfc_main = {
  ...
  methods: {
    ...
    tapCode(e) {
      common_vendor.index.__f__("log", "at components/alertCode/alertCode.vue:64", e);
      e.stopPropagation();
    },
    closeMe(e) {
      this.isShow = false;
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3ecbf296"]]);
