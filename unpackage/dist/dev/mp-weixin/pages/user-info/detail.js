  ...
  return {
    a: common_vendor.w(({
      ...
      return common_vendor.e({
        ...
        m: "206c924f-3-" + i0 + ",206c924f-0",
        n: common_vendor.p({
          href: "mailto:" + data.email,
          text: data.email
        }),
        o: "206c924f-4-" + i0 + ",206c924f-0",
        p: common_vendor.p({
          href: data.url,
          download: data.url,
          text: data.url
    ...
    b: common_vendor.sr("udb", "206c924f-0"),
    c: common_vendor.p({
