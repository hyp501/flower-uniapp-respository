...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "6a7204c8-2-" + i0 + "-" + i1 + "," + ("6a7204c8-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "6a7204c8-1-" + i0 + ",6a7204c8-0"
      } : {}, {
        c: data,
        g: "6a7204c8-3-" + i0 + ",6a7204c8-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "6a7204c8-0"),
    c: common_vendor.p({
    ...
    d: common_vendor.sr("fab", "6a7204c8-4"),
