...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.w(({
      ...
      return {
        a: "40904251-4-" + i0 + "," + ("40904251-3-" + i0),
        b: "40904251-5-" + i0 + "," + ("40904251-3-" + i0),
        c: "40904251-6-" + i0 + "," + ("40904251-3-" + i0),
        d: "40904251-7-" + i0 + "," + ("40904251-3-" + i0),
        e: "40904251-8-" + i0 + "," + ("40904251-3-" + i0),
        f: "40904251-9-" + i0 + "," + ("40904251-3-" + i0),
        g: "40904251-10-" + i0 + "," + ("40904251-3-" + i0),
        h: "40904251-11-" + i0 + "," + ("40904251-3-" + i0),
        i: "40904251-3-" + i0 + "," + ("40904251-2-" + i0),
        j: common_vendor.f(data, (item, index, i1) => {
          return {
            a: common_vendor.t(item.appid),
            b: "40904251-13-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            c: common_vendor.t(item.title || "-"),
            d: "40904251-14-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            ...
            i: "40904251-15-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            j: "40904251-17-" + i0 + "-" + i1 + "," + ("40904251-16-" + i0 + "-" + i1),
            k: common_vendor.p({
            ...
            l: "40904251-16-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            m: common_vendor.t(item.version),
            n: "40904251-18-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            o: common_vendor.t(item.stable_publish == true ? "已上线" : "已下线"),
            p: "40904251-19-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            q: "40904251-21-" + i0 + "-" + i1 + "," + ("40904251-20-" + i0 + "-" + i1),
            r: common_vendor.p({
              format: "yyyy-MM-dd hh:mm:ss",
              date: item.create_date,
              threshold: [0, 0]
            }),
            s: "40904251-20-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            t: common_vendor.o(($event) => $options.navigateTo("./detail?id=" + item._id, false), index),
            v: "40904251-22-" + i0 + "-" + i1 + "," + ("40904251-12-" + i0 + "-" + i1),
            w: index,
            x: "40904251-12-" + i0 + "-" + i1 + "," + ("40904251-2-" + i0),
            y: common_vendor.p({
              disabled: item.stable_publish
            })
          };
        }),
        k: "40904251-2-" + i0 + ",40904251-1",
        l: common_vendor.p({
          loading,
    ...
    H: common_vendor.sr("udb", "40904251-1"),
    I: common_vendor.p({
